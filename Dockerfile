...
RUN sed -i.bak -E 's#this\.manager\?\.[[:space:]]*hasFeatureEnabled\(feature\)[[:space:]]*\?\?[[:space:]]*false#true#g' /usr/local/lib/node_modules/n8n/dist/license.js && \
    ...
    sed -i.bak -E "s#this\.getValue\('planName'\)[[:space:]]*\?\?[[:space:]]*'Community';#'Enterprise';#g" /usr/local/lib/node_modules/n8n/dist/license.js && \
    ...
    sed -i.bak "s#const limit =.*/const limit = 999;#" /usr/local/lib/node_modules/n8n/dist/services/project.service.ee.js
